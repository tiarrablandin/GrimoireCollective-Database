...
--   - Salt type/purpose: entity_intentions (entity_type='salt')
--   - Magical properties: entity_intentions (entity_type='salt')
--   - Element associations: entity_elements (entity_type='salt')
--   - Planet associations: entity_planets (entity_type='salt')
--   - Zodiac associations: entity_zodiac_signs (entity_type='salt')
-- =============================================================================
