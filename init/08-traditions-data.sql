...
--
-- NORMALIZATION NOTES:
-- - deities_honored: Removed - now using entity_deities table (entity_type='tradition')
-- - related_traditions: Removed - now using entity_pairings table (pairing_type='related')
-- - resources column contains educational materials (books, websites, courses, etc.)
-- =============================================================================

INSERT INTO traditions (name, slug, tradition_type, description, origin, time_period, key_beliefs, common_practices, resources) VALUES
    -- Practice Styles
    ('Solitary Practice', 'solitary', 'practice_style',
     ...
     ARRAY['Solitary Witch by Silver RavenWolf', 'The Spiral Dance by Starhawk']),
    ...
    ('Coven Practice', 'coven', 'practice_style',
     ...
     ARRAY['A Witches'' Bible by Janet and Stewart Farrar', 'The Spiral Dance by Starhawk']),
    ...
    ('Eclectic Practice', 'eclectic', 'eclectic',
     ...
     ARRAY['Eclectic Wicca by Kaatryn MacMorgan-Douglas']),
    ...
    ('Hereditary Practice', 'hereditary', 'practice_style',
     ...
     ARRAY['Hereditary Witchcraft by Raven Grimassi']),
    ...
    ('Wicca', 'wicca', 'religious',
     ...
     ARRAY['Wicca: A Guide for the Solitary Practitioner by Scott Cunningham', 'The Spiral Dance by Starhawk']),
    ...
    ('Gardnerian Wicca', 'gardnerian', 'religious',
     ...
     ARRAY['Witchcraft Today by Gerald Gardner', 'The Meaning of Witchcraft by Gerald Gardner']),
    ...
    ('Alexandrian Wicca', 'alexandrian', 'religious',
     ...
     ARRAY['A Witches'' Bible by Janet and Stewart Farrar']),
    ...
    ('Dianic Wicca', 'dianic', 'religious',
     ...
     ARRAY['The Holy Book of Women''s Mysteries by Zsuzsanna Budapest', 'The Spiral Dance by Starhawk']),
    ...
    ('Traditional Witchcraft', 'traditional-witchcraft', 'cultural',
     ...
     ARRAY['Traditional Witchcraft: A Cornish Book of Ways by Gemma Gary', 'Treading the Mill by Nigel G. Pearson']),
    ...
    ('Kitchen Witch', 'kitchen-witch', 'modern',
     ...
     ARRAY['The Kitchen Witch by Soraya', 'Cunningham''s Encyclopedia of Wicca in the Kitchen by Scott Cunningham']),
    ...
    ('Green Witch', 'green-witch', 'modern',
     ...
     ARRAY['The Green Witch by Arin Murphy-Hiscock', 'Garden Witchery by Ellen Dugan']),
    ...
    ('Hedge Witch', 'hedge-witch', 'cultural',
     ...
     ARRAY['Hedge Witch by Rae Beth', 'The Hedge Rider''s Manual by Christopher Orapello and Tara-Love Maguire']),
    ...
    ('Cottage Witch', 'cottage-witch', 'modern',
     ...
     ARRAY['Cottage Witchery by Ellen Dugan', 'The Cottage Witch''s Guide by Soraya']),
    ...
    ('Cosmic Witch', 'cosmic-witch', 'modern',
     ...
     ARRAY['Astrology for the Soul by Jan Spiller', 'The Inner Sky by Steven Forrest']),
    ...
    ('Hellenism', 'hellenism', 'reconstructionist',
     ...
     ARRAY['Hellenic Polytheism: Household Worship by LABRYS', 'Kharis: Hellenic Polytheism Explored by Sarah Kate Istra Winter']),
    ...
    ('Heathenry', 'heathenry', 'reconstructionist',
     ...
     ARRAY['Essential Asatru by Diana Paxson', 'A Practical Heathen''s Guide to Asatru by Patricia M. Lafayllve']),
    ...
    ('Kemeticism', 'kemeticism', 'reconstructionist',
     ...
     ARRAY['The Ancient Egyptian Prayerbook by Tamara Siuda', 'Eternal Egypt by Richard Reidy']),
    ...
    ('Celtic Reconstructionism', 'celtic-reconstructionist', 'reconstructionist',
     ...
     ARRAY['The CR FAQ by Kathryn Price NicDhàna', 'Celtic Reconstructionist Paganism by Kathryn Price NicDhàna']),
    ...
    ('Druidry', 'druidry', 'modern',
     ...
     ARRAY['The Druid Way by Philip Carr-Gomm', 'The Path of Druidry by Penny Billington']),
    ...
    ('Ceremonial Magic', 'ceremonial-magic', 'modern',
     ...
     ARRAY['The Golden Dawn by Israel Regardie', 'Modern Magick by Donald Michael Kraig']),
    ...
    ('Chaos Magic', 'chaos-magic', 'modern',
     ...
     ARRAY['Condensed Chaos by Phil Hine', 'Liber Null & Psychonaut by Peter J. Carroll']),
    ...
    ('Folk Magic', 'folk-magic', 'cultural',
     ...
     ARRAY['American Folk Magick by Silver RavenWolf', 'The Encyclopedia of 5000 Spells by Judika Illes']);
