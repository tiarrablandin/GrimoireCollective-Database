...
-- SPELL METHODS DATA
-- =============================================================================
-- Specific techniques for casting spells and rituals
--
-- NORMALIZATION APPLIED:
-- - materials_needed: REMOVED - materials are actual entities in the database
--   (crystals, herbs, candles, oils, etc.). When creating actual spells,
--   link specific materials via grimoire_crystals, grimoire_herbs, grimoire_candles, etc.
-- - related_methods: Moved to entity_pairings polymorphic table (see below)
-- =============================================================================

INSERT INTO spell_methods (name, slug, description, difficulty_level, typical_duration, instructions_summary, tips, warnings) VALUES
...
-- =============================================================================
-- SPELL METHOD RELATIONSHIPS
-- =============================================================================
-- Moved to 14-calendar-relationships.sql (runs after entity_pairings table is created)
-- =============================================================================
